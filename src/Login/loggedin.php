...
<div class="w3-bar w3-black w3-padding">
    ...
    <a href="signup.php" class="w3-bar-item w3-button w3-mobile">Men's</a>
    ...
    <?php if (!isset($_SESSION['logged_in']) || $_SESSION['logged_in'] !== true): ?>
        <a href="logoutAction.php" class="w3-bar-item w3-button loginmargin">
            <i class="fa fa-sign-out"></i> Logged in As
        </a>
    <?php endif; ?>
